# Randomized Most Idle

This repository includes all the python codes related to Randomized Most Idle (RMI) strategy used in "Queue Routing Strategies to Improve Equitable Housing Coordination in New York City" paper.
